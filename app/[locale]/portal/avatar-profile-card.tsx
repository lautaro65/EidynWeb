      ...
      {isEditing && (
        <div className="mt-6 flex items-center gap-2 relative z-10 pt-4 border-t border-border/50">
          ...
          <button
            onClick={handleSave}
            disabled={isLoading}
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground font-medium rounded-xl transition-all text-sm shadow-lg shadow-primary/20"
          >
