  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        {/* Modelos 3D */}
        <div className="bg-background/40 backdrop-blur-2xl border border-border/50 p-6 rounded-[2rem] relative overflow-hidden group hover:border-primary/30 transition-all duration-500 shadow-xl">
        ...
        <div className="bg-background/40 backdrop-blur-2xl border border-border/50 p-6 rounded-[2rem] relative overflow-hidden group hover:border-blue-500/30 transition-all duration-500 shadow-xl">
          <div className="absolute -right-6 -top-6 p-8 opacity-5 group-hover:opacity-10 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 pointer-events-none">
          ...
          <div className="flex items-end gap-3">
            ...
            <span className="text-sm font-medium text-muted-foreground mb-1.5 border-b border-border/50 pb-0.5">{t("total")}</span>
          </div>
        ...
        {/* Tiendas Autorizadas */}
        <div className="bg-background/40 backdrop-blur-2xl border border-border/50 p-6 rounded-[2rem] relative overflow-hidden group hover:border-purple-500/30 transition-all duration-500 shadow-xl">
          <div className="absolute -right-6 -top-6 p-8 opacity-5 group-hover:opacity-10 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 pointer-events-none">
        ...
        {/* Guías de Talles */}
        <div className="bg-background/40 backdrop-blur-2xl border border-border/50 p-6 rounded-[2rem] relative overflow-hidden group hover:border-amber-500/30 transition-all duration-500 shadow-xl">
          <div className="absolute -right-6 -top-6 p-8 opacity-5 group-hover:opacity-10 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 pointer-events-none">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
        ...
        {/* Activity Chart Area */}
        <div className="lg:col-span-2 bg-background/40 backdrop-blur-2xl border border-border/50 rounded-[2rem] p-8 shadow-xl flex flex-col">
          ...
          {/* CSS Mock Chart */}
          <div className="flex-1 flex items-end gap-2 sm:gap-4 mt-auto pt-10 h-64 border-b border-border/50 pb-2">
        ...
        {/* Try-On History List */}
        <div className="bg-background/40 backdrop-blur-2xl border border-border/50 rounded-[2rem] p-8 shadow-xl flex flex-col">
          ...
          <div className="space-y-4 flex-1">
            {[
              ...
              <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-muted/50 transition-colors cursor-default border border-transparent hover:border-border/50">
                ...
                <div className="text-[10px] text-muted-foreground font-medium whitespace-nowrap bg-muted/50 px-2 py-1 rounded-md">
                  {item.time}
                </div>
              </div>
            ))}
